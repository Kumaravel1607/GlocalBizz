...
class SetNewPassword extends StatefulWidget {
  final String email;
  SetNewPassword({Key key, this.email}) : super(key: key);
...
class _SetNewPasswordState extends State<SetNewPassword> {
  ...
  void setNew_pass(
    ...
    var jsonResponse;
    var response =
        await http.post(Uri.parse(api_url + "/new_password"), body: data);
  ...
  void submitButton() {
    if (_formKey.currentState.validate()) {
      ...
      if (newPassword.text == confirmPassword.text) {
        setNew_pass(newPassword.text, confirmPassword.text);
      } else {
